    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">For Renters</h2>
          <p className="text-sm text-gray-600">
            Looking for help finding an apartment? Browse our listings or reach out with specific questions about properties.
          </p>
        </div>
        <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">For Property Managers</h2>
          <p className="text-sm text-gray-600">
      ...
      <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
        ...
        {success ? (
          <div className="p-6 bg-emerald-50 rounded-xl border border-emerald-200 text-center">
            <p className="text-emerald-700 font-medium text-lg mb-2">Message sent!</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full sm:w-auto px-6 py-3 bg-emerald-600 text-white font-medium rounded-xl hover:bg-emerald-700 transition-colors shadow-lg shadow-emerald-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
