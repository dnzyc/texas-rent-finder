        ...
        {[...Array(5)].map((_, i) => (
          <div key={i} className="p-4">
            <div className="flex gap-4">
              <div className="w-20 h-20 sm:w-28 sm:h-24 rounded-xl bg-gray-100 dark:bg-gray-800 animate-pulse flex-shrink-0" />
              <div className="flex-1 space-y-2">
                <div className="h-4 bg-gray-100 dark:bg-gray-800 animate-pulse rounded w-3/4" />
                <div className="h-3 bg-gray-100 dark:bg-gray-800 animate-pulse rounded w-1/2" />
                <div className="h-3 bg-gray-100 dark:bg-gray-800 animate-pulse rounded w-1/4" />
              </div>
            </div>
          </div>
        ))}
  ...
  if (places.length === 0) {
    return (
      <div className="p-12 text-center">
        ...
        <p className="text-gray-900 dark:text-white font-medium mb-1">No apartments found</p>
